...
const footer = () => {
  return (
    <div className='h-[75vh] w-[100vw] bg-[#121212] pt-8 flex flex-col justify-center items-center'>
      ...
      <div className='footermain h-[10%] w-[100%] flex justify-center items-center mx-48'>
