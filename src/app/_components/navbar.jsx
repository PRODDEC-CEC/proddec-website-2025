...
const Navbar = () => {
    ...
    return (
        ...
        <div className="w-full flex justify-center items-center ">
            <div
            id="navbar"
            className={`text-orangepeel fixed left-0 right-0 mx-auto z-50 transition-[width, top, box-shadow, opacity] duration-500 ease-in-out ${
                isScrolled
                    ? 'md:w-11/12 bg-[rgba(34,34,34,0.4)] rounded-md '
                    : 'w-full top-14'
